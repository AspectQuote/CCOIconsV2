...
export declare const prefixSchema: {
    ...
    readonly roaring: {
        ...
        readonly multiplier: 111;
        readonly desc: "Hopefully it doesn't have a Black Knife!";
        readonly universal: false;
        readonly dropParties: true;
        readonly dropPartyDateRange: [];
    ...
    readonly addicted: {
        readonly name: "Addicted";
        readonly multiplier: 49;
        readonly desc: "*sigh* just one more spin...";
        readonly universal: false;
        readonly dropParties: true;
        readonly dropPartyDateRange: [];
        readonly elements: ["Poisonous"];
...
export declare const prefixApplicationOrderObject: {
    fake: 1;
    dotted: 1;
    rippling: 1;
    musical: 1;
...
export declare const prefixApplicationOrder: PrefixID[];
export declare function sortPrefixesByApplicationOrder(prefixes: PrefixID[], direction?: 1 | -1): void;
